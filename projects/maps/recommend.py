...
def group_by_centroid(restaurants, centroids):
    ...
    for r in restaurants:
        candr += [[find_closest(restaurant_location(r), centroids)] + [r]]
    return group_by_first(candr)
    # END Question 4
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    "*** YOUR CODE HERE ***"
    lst = [find_predictor(user, reviewed, f) for f in feature_fns]
...
def rate_all(user, restaurants, feature_fns):
    ...
    reviewed = user_reviewed_restaurants(user, restaurants)     # a list of restaurants
    # BEGIN Question 9
    "*** YOUR CODE HERE ***"
    '''
    predic = {}
