...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if cur == 1:
            pig_out = 1
        total, num_rolls = total + cur, num_rolls - 1
    return pig_out or total     # great!!!
    # END PROBLEM 1
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return 2 + abs((score % 10 - score // 10 % 10))
    # END PROBLEM 2
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7           # a little stuck
    "*** YOUR CODE HERE ***"
    def genesay(point):
        if point == 1:
            print(point, "point! That's the biggest gain yet for Player", who)
        else:
    ...
    def say(score0, score1):
        if who == 0:
            return genescore(score0)
        else:
            return genescore(score1)
    return say
...
def make_averaged(fn, num_samples=1000):
    ...
    def average(*args):
        ...
        while count < num_samples:
            total, count = total + fn(*args), count + 1
        #print(count)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    do_averge = make_averaged(roll_dice, num_samples)
    num, maxx, curr = 1, 0, 1
    while num <= 10:
        aver = do_averge(num, dice)
        if aver > maxx:
            maxx, curr = aver, num
        num += 1
    return curr
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    # return 4  # Replace this statement
    expect_score = score + free_bacon(opponent_score)
    if expect_score < opponent_score and is_swap(opponent_score, expect_score):
        return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    # return 4  # Replace this statement
    return swap_strategy(score, opponent_score, margin=10, num_rolls=2)
    # END PROBLEM 12
